...
@section("scripts")
  ...
  <script src="{{ asset('assets/admin/') }}/assets/js/lib/vector-map/jquery.vmap.js"></script>
  <script src="{{ asset('assets/admin/') }}/assets/js/lib/vector-map/jquery.vmap.min.js"></script>
  <script src="{{ asset('assets/admin/') }}/assets/js/lib/vector-map/jquery.vmap.sampledata.js"></script>
  <script src="{{ asset('assets/admin/') }}/assets/js/lib/vector-map/country/jquery.vmap.world.js"></script>
  <script>
      ( function ( $ ) {
          "use strict";
