...
<head>
    ...
    <title>abbc24 Admin - @yield("title")</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/admin/') }}/assets/scss/style.css">
                ...
                <nav class="navbar navbar-expand-sm navbar-default">
                    ...
                    <div id="main-menu" class="main-menu collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="{{ url('') }}/admin/news"> <i class="menu-icon fa fa-tasks"></i>News</a>
                            </li>
